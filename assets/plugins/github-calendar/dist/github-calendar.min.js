                            ...
                            if (c.global_stats !== !1) {
                                var d = n(r("svg", f).outerHTML),
                                    ...
                                    m = r("<div>", {
                                        ...
                                        html: '<span class="text-muted" style="color:#fff;font-weight:900;background: rgba(255, 193, 7, 0.41);">писал код<br><span class="contrib-number" style="color:#fff;font-weight:900;margin-top:-8px;">' + d.longest_streak + '</span>дней подряд<br></span>\n                                                    <span class="text-muted">' + g + "</span>"
                                    }),
                                    b = r("<div>", {
                                        "class": "contrib-column table-column",
