    ...
    return function e(t, n, r) {
        ...
        1: [function(e, t) {
            ...
            t.exports = function(e, t, c) {
                e = r(e), c = c || {}, c.summary_text = c.summary_text || 'Статистика / Производительность <a style="font-size: 2em;position: absolute;top: 50px;left: 45px;" href="https://github.com/' + t + '" target="blank">@' + t + "</a>", c.global_stats === !1 && (e.style.minHeight = "175px"), c.proxy = c.proxy || function(e) {
                            ...
                            if (c.global_stats !== !1) {
                                var d = n(r("svg", f).outerHTML),
                                    ...
                                    m = r("<div>", {
                                        ...
                                        html: '<span class="text-muted" style="color:#fff;font-weight:900;">писал код<br><span class="contrib-number" style="color:#fff;font-weight:900;margin-top:-8px;">' + d.longest_streak + '</span>дней подряд</span>\n                               <span class="contrib-number" style="color:#fff;font-weight:900;margin-top:-8px;">' + d.longest_streak + '</span>\n                               <span class="text-muted">' + g + "</span>"
                                    }),
                                    b = r("<div>", {
                                        "class": "contrib-column table-column",
