                            ...
                            if (c.global_stats !== !1) {
                                var d = n(r("svg", f).outerHTML),
                                    ...
                                    m = r("<div>", {
                                        ...
                                        html: '<span class="text-muted">Непрерывно писал код</span>\n                               <span class="contrib-number">' + d.longest_streak + ' дней</span>\n                               <span class="text-muted">' + g + "</span>"
                                    }),
                                    b = r("<div>", {
                                        "class": "contrib-column table-column",
                                        html: '<span class="text-muted">Пишет непрерывно</span>\n                               <span class="contrib-number">' + d.current_streak + ' дней</span>\n                               <span class="text-muted">' + p + "</span>"
                                    });
