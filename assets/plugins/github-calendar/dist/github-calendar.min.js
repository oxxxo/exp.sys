    ...
    return function e(t, n, r) {
        ...
        1: [function(e, t) {
            ...
            t.exports = function(e, t, c) {
                e = r(e), c = c || {}, c.summary_text = c.summary_text || 'Статистика /  <a style="font-size: 2em;position: absolute;top: 50px;left: 45px;" href="https://github.com/' + t + '" target="blank">@' + t + "</a>", c.global_stats === !1 && (e.style.minHeight = "175px"), c.proxy = c.proxy || function(e) {
                            ...
                            if (c.global_stats !== !1) {
                                var d = n(r("svg", f).outerHTML),
                                    ...
                                    y = r("<div>", {
                                        ...
                                        html: '<span class="text-muted">Правок в этом году</span>\n                               <span class="contrib-number">' + d.last_year + ' всего</span>\n                               <span class="text-muted">' + o(a.subtract(new Date, 1, "year"), u) + " – " + o(new Date, u) + "</span>"
                                    }),
                                    m = r("<div>", {
                                        "class": "contrib-column table-column",
                                        html: '<span class="text-muted" style="color:#fff;font-weight:900;background:rgba(159, 168, 218, 0.43);padding:20px;text-align:center;border-radius:11px;position:absolute;left:100px;top:205px;">писал код<br><span class="contrib-number" style="color:#fff;font-weight:900;margin-top:-8px;">' + d.longest_streak + '</span>дней подряд<br><span class="text-muted">' + g + "</span></span>\n                                                    "
                                    }),
                                    b = r("<div>", {
                                        "class": "contrib-column table-column",
                                        html: '<span class="text-muted">Пишет сейчас</span>\n                               <span class="contrib-number">' + d.current_streak + ' дней</span>\n                               <span class="text-muted">' + p + "</span>"
                                    });
