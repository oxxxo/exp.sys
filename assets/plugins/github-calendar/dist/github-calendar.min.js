                            ...
                            if (c.global_stats !== !1) {
                                var d = n(r("svg", f).outerHTML),
                                    ...
                                    m = r("<div>", {
                                        ...
                                        html: '<span class="text-muted" style="color:#fff;font-weight:900;background:rgba(92, 92, 92, 0.3);padding:40px;text-align:center;border-radius:11px;">писал код<br><span class="contrib-number" style="color:#fff;font-weight:900;margin-top:-8px;">' + d.longest_streak + '</span>дней подряд<br></span>\n                                                    <span class="text-muted">' + g + "</span>"
                                    }),
                                    b = r("<div>", {
                                        "class": "contrib-column table-column",
