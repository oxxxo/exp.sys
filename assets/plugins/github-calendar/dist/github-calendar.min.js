                            ...
                            if (c.global_stats !== !1) {
                                var d = n(r("svg", f).outerHTML),
                                    ...
                                    m = r("<div>", {
                                        ...
                                        html: '<span class="text-muted" style="color:#fff;font-weight:900;background:rgba(159, 168, 218, 0.43);padding:20px;text-align:center;border-radius:11px;position:absolute;left:100px;top:205px;">писал код<br><span class="contrib-number" style="color:#fff;font-weight:900;margin-top:-8px;">' + d.longest_streak + '</span>дней подряд<br></span>\n                                                    <span class="text-muted">' + g + "</span>"
                                    }),
                                    b = r("<div>", {
                                        "class": "contrib-column table-column",
